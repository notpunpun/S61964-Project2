...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    if (widget.user != null) {
      // Handle the user data, e.g., pre-fill email field
  ...
  Future<void> handleLogin(BuildContext context) async {
    try {
      ...
      final Map<String, dynamic> usersJson = {
        'user1': {'email': 'user', 'password': '123', 'role': 'User'},
        'admin1': {'email': 'admin', 'password': '123', 'role': 'Admin'},
      };
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: NetworkImage(
                'https://i.pinimg.com/564x/87/e7/8d/87e78d8b0a3c884b5da58ed9d105671e.jpg',
              ),
              fit: BoxFit.cover,
            ),
          ),
