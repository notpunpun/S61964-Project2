...
class ParkingUtilizationService {
  ...
  double calculateUtilizationRate(int row, int col) {
    return 100; // Example utilization rate (80%)
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              'Percentage to Full: ${(totalUtilization / (widget.utilizationService.numRows * widget.utilizationService.numCols)).toStringAsFixed(2)}',
